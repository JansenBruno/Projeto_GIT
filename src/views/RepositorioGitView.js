class RepositorioGitView {
    ...
    template(repositorio) {
        ...
        <p>Visite o repositorio e deixe uma estrela ⭐</p> 
       
        <a id="perfil" href="${repositorio.link}"><svg width="3em" height="3em" viewBox="0 0 16 16" id="teste" class="bi bi-folder-plus"
